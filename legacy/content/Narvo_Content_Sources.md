...
A breakdown of content sources for the Narvo platform and how they feed into narrative building.

*The live list of RSS feeds used by the app is maintained in the backend news service. Fact-check uses Google Fact Check API; voice uses OpenAI and YarnGPT. Dubawa and ElevenLabs are planned or optional.*
...
| France 24            | [france24.com](https://www.france24.com)           | RSS Parser, Playwright     |
| DW (Deutsche Welle)  | [dw.com](https://www.dw.com)                       | RSS Parser, Playwright     |
| AllAfrica            | [allafrica.com](https://allafrica.com)             | RSS Parser, Playwright     |
...
| **Continental (Africa)** |                                                |                            |
| The Africa Report    | [theafricareport.com](https://www.theafricareport.com) | RSS Parser, Playwright  |
| Mail & Guardian     | [mg.co.za](https://mg.co.za)                       | RSS Parser, Playwright     |
| The Conversation Africa | [theconversation.com/africa](https://theconversation.com/africa) | RSS/Atom Parser, Playwright |
...
| Arise News          | Local  | [arise.tv](https://www.arise.tv)                     | YouTube API, Whisper (STT), ffmpeg; RSS |
